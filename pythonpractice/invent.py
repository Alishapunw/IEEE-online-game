...
def main():
    ...
    while True: # main game loop
        ...
        draw_score(DISPLAYSURF,100,100,score)
        ...
        draw_timer(DISPLAYSURF, 600, 100, time_left) #Once we have calculated how much time is left, draw the timer
...
def game_intro():
    ...
    while intro:
        ...
        text = font.render("Time Left = ", 1, WHITE) #Create the text
        pygame.display.update()
        clock.tick(15)
